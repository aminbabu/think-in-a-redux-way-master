  ...
  return (
    <section className="section">
      <div className="container">
        <div className="grid place-items-center gap-12 md:gap-16 text-center">
          <svg
            data-name="Layer 1"
            ...
            className="max-w-full w-72 h-72 md:w-80 md:h-80 animate-pulse"
          >
            <path
          ...
          <div>
            ...
            {children ? (
              ...
              <Link to="/" className="text-lg link mt-8">
                Go Back to Home
              </Link>
            )}
          </div>
