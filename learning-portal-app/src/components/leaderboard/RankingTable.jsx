const RankingTable = ({ rankingData = [], currentUser }) => {
  return (
    <div className="mb-4 md:mb-6">
      <h2 className="text-lg font-bold mb-4 md:mb-6">Top 20 Ranking</h2>
      <div className="table-responsive">
        <table className="w-full table-auto border border-gray-600/50 text-center">
          <thead className="text-slate-300 border-b border-b-gray-600/50">
            <tr>
              <th>Rank</th>
          ...
          <tbody className="text-slate-400 divide-y divide-gray-600/50">
            {rankingData.map((item, index) => (
              <tr
                key={item?.student_id}
                className={
                  item?.student_id === currentUser?.student_id
              ...
              >
                ...
                <td>{item?.quizMark}</td>
                <td>{item?.assignmentMark}</td>
                <td>{item?.quizMark + item?.assignmentMark}</td>
              </tr>
            ))}
          </tbody>
        </table>
