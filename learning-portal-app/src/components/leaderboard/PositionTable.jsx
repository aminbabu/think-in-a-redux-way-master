const PositionTable = ({ currentUser }) => {
  const { student_name, quizMark, assignmentMark, rank } = currentUser || {};
        ...
        <table className="w-full table-auto border border-gray-600/50 text-center">
          ...
          <tbody className="text-slate-400 divide-y divide-gray-600/50">
            <tr className="!border-2 !border-violet-600">
              ...
              <td className="text-left">{student_name}</td>
              <td>{quizMark}</td>
              <td>{assignmentMark}</td>
              <td>{quizMark + assignmentMark}</td>
            </tr>
          </tbody>
        </table>
      </div>
